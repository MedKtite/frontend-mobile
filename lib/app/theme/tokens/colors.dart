...
class AppColors {
  ...
  // ── Tablet onboarding (fixed editorial night palette) ─────────
  // These screens intentionally stay dark in both system themes, matching the
  // dedicated iPad Figma frames rather than inheriting the app surface mode.
  static const onboardingBg = Color(0xFF0F0E0C);
  static const onboardingSurface = Color(0xFF1A1810);
  static const onboardingGold = Color(0xFFC4A96D);
  static const onboardingText = Color(0xFFF2ECD8);
  static const onboardingText2 = Color(0x8CF2ECD8); // 0.55
  static const onboardingText3 = Color(0x45F2ECD8); // 0.27

  // ── Discovery genres (fixed editorial palette) ────────────────
  // Purposefully independent of theme mode, like printed section tabs.
  static const genreEssays = Color(0xFF3E5596);
  static const genreFiction = Color(0xFF315143);
  static const genrePoetry = Color(0xFFE8DDC2);
  static const genrePhilosophy = Color(0xFF1D1D1F);
  static const genreNature = Color(0xFFB34F3F);
  static const genreBiography = Color(0xFFA9A184);
