...
class AppTypography {
  ...
  // Families ────────────────────────────────────────────────────────
  static TextStyle serif([TextStyle? base])    => GoogleFonts.sourceSerif4(textStyle: base);
  static TextStyle sans([TextStyle? base])     => GoogleFonts.inter(textStyle: base);
  static TextStyle reading([TextStyle? base])  => GoogleFonts.newsreader(textStyle: base);
  ...
  static TextStyle wordmark(Color color) => serif(TextStyle(
        color: color,
        fontSize: 40,
        height: 1.0,
  ...
  static TextStyle statNumber(Color color) => serif(TextStyle(
        color: color,
        fontSize: 76,
        height: 0.95,
        fontWeight: FontWeight.w500,
  ...
  static TextStyle display(Color color, {FontWeight? fontWeight}) => serif(TextStyle(
        color: color,
        fontSize: 34,
        height: 1.02,
  ...
  static TextStyle title1(Color color) => serif(TextStyle(
        color: color,
        fontSize: 30,
        height: 1.05,
        fontWeight: FontWeight.w500,
  ...
  static TextStyle title2(Color color) => serif(TextStyle(
        color: color,
        fontSize: 24,
        height: 1.10,
        fontWeight: FontWeight.w500,
  ...
  static TextStyle title3(Color color) => serif(TextStyle(
        color: color,
        fontSize: 18,
        height: 1.2,
        fontWeight: FontWeight.w500,
  ...
  static TextStyle bodySerif(Color color) => reading(TextStyle(
        color: color,
        fontSize: 18,
        height: 1.55,
      ));
  ...
  static TextStyle body(Color color) => sans(TextStyle(
        color: color,
        fontSize: 16,
        height: 1.50,
      ));
  ...
  static TextStyle subtitle(Color color) => serif(TextStyle(
        color: color,
        fontSize: 16,
        height: 1.50,
  ...
  static TextStyle label(Color color) => sans(TextStyle(
        color: color,
        fontSize: 14,
        height: 1.40,
      ));
  ...
  static TextStyle caption(Color color) => sans(TextStyle(
        color: color,
        fontSize: 12,
        height: 1.40,
      ));
  ...
  static TextStyle overline(Color color) => sans(TextStyle(
        color: color,
        fontSize: 10,
        height: 1.40,
        letterSpacing: 1.6,
