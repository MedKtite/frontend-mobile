...
final gutenbergProgressProvider = StateProvider.autoDispose
    .family<double, String>((ref, bookId) => 0);
...
final gutenbergEpubProvider = FutureProvider.autoDispose
    .family<File, GutenbergRef>((ref, key) async {
      ...
      void reportProgress(double v) =>
          ref.read(gutenbergProgressProvider(key.id).notifier).state = v.clamp(
            0.0,
            1.0,
          );
      reportProgress(0);
